...
`border-radius: 14px`: redondea las esquinas con `14px`.

`overflow: hidden`: controla el contenido desbordado mediante `hidden`.

`background: rgba(255,255,255,.04)`: aplica el fondo `rgba(255,255,255,.04)`.

`box-shadow: 0 6px 20px rgba(0,0,0,.25)`: aplica la sombra `0 6px 20px rgba(0,0,0,.25)`.
...
`box-shadow: 0 18px 36px rgba(0,0,0,.45)`: aplica la sombra con el valor `0 18px 36px rgba(0,0,0,.45)`.

`backdrop-filter: blur(8px) saturate(140%)`: aplica un filtro al contenido situado detrás con el valor `blur(8px) saturate(140%)`.

`animation: floatUp .5s ease both`: ejecuta la animación con el valor `floatUp .5s ease both`.
...
`inset: -1px`: sitúa los cuatro bordes con el valor `-1px`.

`border-radius: 20px`: redondea las esquinas con el valor `20px`.

`box-shadow: inset 0 0 0 1px rgba(255,255,255,.08), 0 0 32px rgba(155,92,251,.18)`: aplica la sombra con el valor `inset 0 0 0 1px rgba(255,255,255,.08), 0 0 32px rgba(155,92,251,.18)`.
...
`box-shadow: 0 12px 28px rgba(0,0,0,.5)`: aplica la sombra con el valor `0 12px 28px rgba(0,0,0,.5)`.
...
`transform: scale(1.01)`: aplica la transformación con el valor `scale(1.01)`.

`transition: transform .35s ease`: suaviza los cambios indicados con el valor `transform .35s ease`.
