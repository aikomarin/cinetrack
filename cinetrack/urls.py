...
router.register("contenidos", views.ContenidoViewSet, basename="contenido")
...
urlpatterns = [
    ...
    path(
        "guardar-desde-busqueda/",
        views.guardar_desde_busqueda,
        name="guardar_desde_busqueda",
    ),
    ...
    path(
        "maratones/<int:pk>/quitar/<int:contenido_id>/",
        views.quitar_de_maraton,
        name="quitar_de_maraton",
    ),
